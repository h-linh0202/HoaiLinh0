...
function ListProduct() {
  const list = [
    ...
    { id: 2, title: "ÁO VEST DÁNG NGẮN AK02932", price: "999,000₫", img: require('../assets/images/sp2a.jpg') },
    { id: 3, title: "SƠ MI HỌA TIẾT SM03002", price: "899,000₫", img: require('../assets/images/sp3a.jpg') },
    { id: 4, title: "ĐẦM MAXI TRẮNG KÈM ĐAI D04412", price: "1,599,000₫", img: require('../assets/images/sp4a.jpg') },
    { id: 5, title: "ÁO CỔ VEST DÁNG SUÔNG AK02672", price: "999,000₫", img: require('../assets/images/sp5a.jpg') },
    ...
    { id: 9, title: "ÁO VEST PHỐI DÂY XÍCH AK13722", price: "699,000₫", img: require('../assets/images/sp9a.jpg') },
  ...
  return (
    <div className="mx-auto mt-16">
      ...
      <div className="mx-auto">
        <h1 className="text-4xl uppercase font-bold mb-10">Sản phẩm nổi bật</h1>
        <div className="grid grid-cols-12 gap-0">
          ...
          {list.slice(currentIndex1, currentIndex1 + 4).map((product) => (
            <div className="col-span-2 m-1 relative cursor-pointer" 
              style={{ height: '35rem' }} 
              ...
              <div className="h-1/6">
                <h4 className="h-1/2 pt-3 font-semibold text-gray-400">{product.title}</h4>
      ...
      <div className="mx-auto mt-32">
        <h1 className="text-4xl uppercase font-bold mb-10">Độc quyền online</h1>
        <div className="grid grid-cols-12 gap-0">
          <div className="col-span-2">
